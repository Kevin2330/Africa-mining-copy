...
# Load the CSV file
df = pd.read_csv('/home/kaiwen1/30123-Project-Kaiwen/matched_without_distance_5000m.csv')

# Filter the data to only include rows where potential_mining = 0
df = df[df['potential_mining'] == 1]
...
def main():
    ...
    if rank == 0:
        ...
        result_df.to_csv('/home/kaiwen1/30123-Project-Kaiwen/complete_data_y1_radius5k.csv', index=False)
